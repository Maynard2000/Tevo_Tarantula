...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //#define  DEFAULT_Kd 440
    ...
    // TEVO Tarantula Custom PID Settings - Hotend Maynard
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // TEVO Tarantula Custom PID Settings - Maynard (mirror)
  #define  DEFAULT_bedKp 141.34
  #define  DEFAULT_bedKi  27.65
  #define  DEFAULT_bedKd 180.62
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,96.65}  // custom steps per unit for TEVO Tarantula Maynard
